...
{-
data Reg32 = EAX -- accumulator for MUL and DIV
           | EBX
           | ECX
           | EDX -- holds upper half of MUL, DIV result
           | ESI
           | EDI
           | EBP  -- frame pointer
           | ESP  -- stack pointer
...
newtype Reg32 = Reg32 Int32  -- TODO: why Int32 and not Int ??
    deriving (Eq, Ord)
